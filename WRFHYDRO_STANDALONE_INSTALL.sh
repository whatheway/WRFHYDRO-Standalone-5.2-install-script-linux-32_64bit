...
#Estimated Run Time ~ 30 - 50 Minutes with 10mb/s downloadspeed.


#############################basic package managment############################
sudo apt update                                                                                                   
sudo apt upgrade                                                                                                    
sudo apt install gcc gfortran g++ libtool automake autoconf make m4 default-jre default-jdk csh ksh tcsh okular cmake time xorg openbox xauth git python3.9 mlocate
...
source $HOME/WRFHYDRO-Standalone-5.2-install.script-linux-32_64bit/Miniconda3_Install.sh
